...
export PATH="/usr/local/share/python:/Users/dana/lib/get-shit-done/:/Users/dana/.gem/ruby/1.8/bin:/user/bin/:/usr/local/bin:/usr/local/sbin:/usr/local/mysql/bin:$PATH"
